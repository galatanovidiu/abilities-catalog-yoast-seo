...
final class GetPostSeo implements ConditionalAbility {
	...
	/**
	 * Splits the stored advanced-robots CSV into a list of directive tokens.
	 *
	 * Yoast free stores only `noimageindex`, `noarchive`, and `nosnippet` here
	 * (research-findings §3.1, `class-wpseo-meta.php:158-166`). An empty stored
